...
export IDNAME_0=w9_IE_DR_8c_32s_4b_scheme_9__0
export IDNAME_1=w9_IE_SNR_8c_32s_4b_scheme_9__0
...
JOBID1=$(sbatch --parsable  --dependency=afterany:${JOBID_9DR}:${JOBID_9SNR} --job-name=R${N_SCH}_${CPUSPERTASK}  --partition=${PARTITION} --ntasks-per-node=${NTASKS} --cpus-per-task=${CPUSPERTASK}  --time=${RUNTIME}  ${PATH_MACRO}/macro_dr/slurm/M_scheme_N_tasks.sh) 
